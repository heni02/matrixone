...
create table p_table_02(col1 int,col2 char(25),col3 decimal(4,2),primary key(col1,col2))partition by key(col2)partitions 2;
...
insert into p_table_05 values (1,'mod',78.9),(2,'proto',0.34),(3,'mod',6.5),(4,'mode',9.0),(5,'make',62.9),(6,'io',88.92);
insert into p_table_05 values (1,'mod',78.9),(2,'proto',0.34),(3,'rep',6.5),(4,'test',9.0),(5,'',62.9),(6,'io',88.92);
select * from `%!%p0%!%p_table_05`;
select * from `%!%p5%!%p_table_05`;
select * from `%!%p8%!%p_table_05`;
select * from `%!%p3%!%p_table_05`;
show create table p_table_05;

-- key partition: char,  unique key
create table p_table_06(col1 int,col2 char(25),col3 decimal(4,2),unique key k2(col1,col2))partition by key(col2)partitions 4;
...
select * from p_table_10 where col1<100;
...
select * from `%!%p2%!%p_table_14`;
select * from `%!%p3%!%p_table_14`;
update table p_table_14 set col4=0.999 where col1=1000;
select * from p_table_14;
...
create table p_table_15(col1 bigint auto_increment,col2 date,col3 varchar(25),col4 decimal(6,4),primary key(col1,col2,col3))partition by key(col2)partitions 8;
...
insert into p_table_15 values ('1999-09-29','res1',0.12),('1999-10-02','res2',0.32),('1999-10-01','opt1',0.64), ('1999-10-01','opt2',0.55),('1999-09-29','oop1',0.87);
...
select * from `%!%p2%!%p_table_15`;
select * from `%!%p3%!%p_table_15`;
update table p_table_15 set col1=100 where col2='1999-09-29';
update table p_table_15 set col2='2022-10-01' where col1>4;
select * from p_table_15;
select * from `%!%p0%!%p_table_15`;
select * from `%!%p1%!%p_table_15`;
select * from `%!%p2%!%p_table_15`;
...
insert into p_table_16 values (1000,'0000-09-29','res1',0.12),(6000,'1999-10-11','opt1',0.89);
...
insert into p_table_temp(col2,col3,col4) values ('1999-09-29','res1',0.12),('1999-10-02','res2',0.32),('1999-10-01','opt1',0.64), ('1999-10-01','opt2',0.55),('1999-09-29','oop1',0.87);
create table p_table_17(col1 bigint unsigned auto_increment,col2 date,col3 varchar(25),col4 decimal(6,4),primary key(col1,col2,col3))partition by key(col2)partitions 8;
insert into p_table_17 select col2,col3,col4 from p_table_temp;
...
create table p_table_19(col1 int,col2 datetime,col3 varchar(25))partition by key(col2)partitions 6;
load data inflie '$resources/load_data/key_partition_data.csv' into p_table_19;
...
-- key partition: binary,varbinary
create table p_table_non(col1 int,col2 binary)partition by key(col2)partitions 4;
create table p_table_non(col1 int,col2 varbinary)partition by key(col2)partitions 4;
-- key partition abnormal type : blob,text,json,enum
create table p_table_non(col1 int,col2 blob)partition by key(col2)partitions 4;
create table p_table_non(col1 int,col2 text)partition by key(col2)partitions 4;
create table p_table_non(col1 int,col2 json)partition by key(col2)partitions 4;
create table p_table_non(col1 int,col2 enum)partition by key(col2)partitions 4;
...
)partition by(act_name) partition 3;
...
insert into p_hash_table_01 values (-120,'78','',90),(84,'334','2021-01-01',34),(20,'55','2021-01-01',72),(-120,'45',NULL,99),(84,'3','2022-11-01',34),(200,'55','2021-08-11',72)
...
create table p_hash_table_04(col1 bigint ,col2 varchar(30),col3 date)partition by hash(year(col3)) partitions 4;
load data infile '$resources/load_data/key_partition_data.csv' into p_hash_table_04;
...
update set col3='2023-09-05' where col1=1000;
update set col1=999 where col3='2010-08-12';
select * from `%!%p0%!%p_hash_table_04`;
select * from `%!%p1%!%p_hash_table_04`;
select * from `%!%p2%!%p_hash_table_04`;
select * from `%!%p3%!%p_hash_table_04`;
delete from p_hash_table_04 where col3='2010-08-12';
select * from `%!%p0%!%p_hash_table_04`;
select * from `%!%p1%!%p_hash_table_04`;
select * from `%!%p2%!%p_hash_table_04`;
select * from `%!%p3%!%p_hash_table_04`;
...
create table p_hash_table_04(col1 bigint ,col2 date default '1970-01-01',col3 varchar(30))partition by hash(year(col3)) partitions 8;
...
create table p_hash_table_06(col1 tinyint,col2 varchar(30),col3 enum)partition by hash(col3) partitions 2;
create table p_hash_table_06(col1 tinyint,col2 varchar(30),col3 Binary)partition by hash(col3) partitions 2;
create table p_hash_table_06(col1 tinyint,col2 varchar(30),col3 varbinary)partition by hash(col3) partitions 2;
