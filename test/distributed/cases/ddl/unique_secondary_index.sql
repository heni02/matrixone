...
insert into index_01 values (67834,'13456789872',20.23,'5678'),(56473,'13873458290',100.00,'5678');
...
create table index_02 (col1 bigint primary key,col2 char(25),col3 float,col4 char(50),unique key num_phone(col2),key num_id(col4));
insert into index_02 values (67834,'13456789872',20.23,'5678'),(56473,'13873458290',100.00,'5678');
insert into index_02 values (1,'13456789872',20.23,'5678'),(2,'13873458290',100.00,'23');
insert into index_02 values (67834,'13456789872',20.23,'4090'),(56473,NULL,100.00,'');
select col2,col4 from index_02;
create table index_03 (col1 bigint auto_increment,col2 int,col3 float,col4 int,unique key id1(col2),key id2(col4));
...
create table index_04 (col1 bigint not null,col2 int primary key,col3 float,col4 bigint,unique key id1(col1),key id2(col4));
insert into index_04 values (67834,2,20.23,4090),(67834,4,100.00,4091);
insert into index_04 values (1,2,20.23,4090),(2,4,100.00,4090);
insert into index_04 values (1,2,20.23,4090),(2,4,100.00,4091),(NULL,3,0.01,NULL);
select * from index_04;
create table index_05 (col1 smallint not null,col2 int primary key,col3 float,col4 smallint,unique key id1(col1),key id2(col4));
insert into index_05 values (1,2,20.23,4090),(1,4,100.00,4091);
insert into index_05 values (1,2,20.23,4090),(2,4,100.00,4090);
insert into index_05 values (1,2,20.23,4090),(2,4,100.00,4091),(NULL,3,0.01,NULL);
select * from index_05;
create table index_06 (col1 tinyint not null,col2 int primary key,col3 float,col4 tinyint,unique key id1(col1),key id2(col4));
insert into index_06 values (1,2,20.23,56),(1,4,100.00,90);
insert into index_06 values (1,2,20.23,56),(2,4,100.00,56);
insert into index_06 values (1,2,20.23,56),(2,4,100.00,41),(NULL,3,0.01,NULL);
select * from index_06;
create table index_07 (col1 int unsigned not null,col2 int primary key,col3 float,col4 int unsigned,unique key id1(col1),key id2(col4));
insert into index_07 values (1,2,20.23,56),(1,4,100.00,90);
insert into index_07 values (1,2,20.23,56),(2,4,100.00,56);
insert into index_07 values (1,2,20.23,56),(2,4,100.00,41),(NULL,3,0.01,NULL);
select * from index_07;
create table index_08 (col1 bigint unsigned not null,col2 int primary key,col3 float,col4 bigint unsigned,unique key id1(col1),key id2(col4));
insert into index_08 values (1,2,20.23,56),(1,4,100.00,90);
insert into index_08 values (1,2,20.23,56),(2,4,100.00,56);
insert into index_08 values (1,2,20.23,56),(2,4,100.00,41),(NULL,3,0.01,NULL);
select * from index_08;
create table index_09 (col1 bigint primary key,col2 decimal(12,16),col3 decimal(12,16),unique key d1(col2),key d2(col3));
insert into index_09 values (1000,20.23,20.00),(1200,20.23,0.10);
insert into index_09 values (1000,20.23,20.00),(1200,0.21,20.00);
...
insert into index_10 values (1000,20.23,20.00),(1200,0.21,20.00);
...
insert into index_11 values (1000,20.23,20.00),(1200,0.21,20.00);
insert into index_11 values (1000,20.23,20.00),(1200,0.23,20.10),(1100,NULL,NULL);
select * from index_11;
create table index_12 (col1 bigint primary key,col2 date,col3 date,unique key d1(col2),key d2(col3));
create table index_13 (col1 bigint primary key,col2 datetime,col3 datetime,unique key d1(col2),key d2(col3));
create table index_14 (col1 bigint primary key,col2 timestamp,col3 timestamp,unique key d1(col2),key d2(col3));
create table index_15 (col1 bigint primary key,col2 blob,col3 blob,unique key d1(col2),key d2(col3));
create table index_16 (col1 bigint primary key,col2 json,col3 json,unique key d1(col2),key d2(col3));
create table index_17 (col1 bigint primary key,col2 text,col3 text,unique key d1(col2),key d2(col3));
insert into index_17 values (235,'5689','132456789'),(236,'5689','232456789');
create table index_18 (col1 bigint primary key,col2 bool,unique key c2(col2));

--unique index include null and not null,''
create table index_table_01 (col1 bigint auto_increment primary key,col2 varchar(25),col3 float default 87.01,col int,unique key num_phone(col2),key num_id(col4));
...
create table index_table_02 (col1 bigint primary key,col2 varchar(25) not null,col3 float default 87.01,col int,unique key num_phone(col2),key num_id(col4));
...
load data infile  "" to t_code_rule infile;
load data s3
...
update table index_table_05 set col2='chart' where col1=2;
...
create table index_table_06 (col1 bigint not null auto_increment,col2 varchar(25),col3 int,col4 varchar(50),primary key (col1),key col2(col2),key col3(col3));
...
insert into index_table_06(col2,col3,col4) values ('read',NULL,'10'),('write','',NULL);
select col2,col3 from index_table_06;

--anormal test :not exists unique/secondary index column
...
insert into create_index_01 values (67834,'13456789872',20.23,'5678'),(56473,'13873458290',100.00,'5678');
...
drop unique index varchar_index;
...
insert into create_index_02 values (67834,'13456789872',20.23,'5678'),(56473,'13873458290',100.00,'5678');
insert into create_index_02 values (1,'13456789872',20.23,'5678'),(2,'13873458290',100.00,'23');
insert into create_index_02 values (67834,'13456789872',20.23,'4090'),(56473,NULL,100.00,'');
select col2,col4 from create_index_02;
drop unique index char_index;
...
drop unique index int_index;
create table create_index_04 (col1 bigint not null,col2 int primary key,col3 float,col4 bigint);
create unique index bigint_index on create_index_04(col2);
insert into create_index_04 values (67834,2,20.23,4090),(67834,4,100.00,4091);
insert into create_index_04 values (1,2,20.23,4090),(2,4,100.00,4090);
insert into create_index_04 values (1,2,20.23,4090),(2,4,100.00,4091),(NULL,3,0.01,NULL);
select * from create_index_04;
create table create_index_05 (col1 smallint not null,col2 int primary key,col3 float,col4 smallint);
...
insert into create_index_07 values (1,2,20.23,56),(2,4,100.00,56);
insert into create_index_07 values (1,2,20.23,56),(2,4,100.00,41),(NULL,3,0.01,NULL);
select * from create_index_07;
create table create_index_08 (col1 bigint unsigned not null,col2 int primary key,col3 float,col4 bigint unsigned);
...
insert into create_index_08 values (1,2,20.23,56),(2,4,100.00,56);
insert into create_index_08 values (1,2,20.23,56),(2,4,100.00,41),(NULL,3,0.01,NULL);
select * from create_index_08;
create table create_index_09 (col1 bigint primary key,col2 decimal(12,16),col3 decimal(12,16));
...
insert into create_index_09 values (1000,20.23,20.00),(1200,0.21,20.00);
...
insert into create_index_10 values (1000,20.23,20.00),(1200,0.21,20.00);
...
insert into create_index_11 values (1000,20.23,20.00),(1200,0.21,20.00);
insert into create_index_11 values (1000,20.23,20.00),(1200,0.23,20.10),(1100,NULL,NULL);
select * from create_index_11;
create table create_index_12(col1 bigint primary key,col2 date,col3 date);
create unique index date_index on create_index_12(col2);
create table create_index_13 (col1 bigint primary key,col2 datetime,col3 datetime);
create unique index datetime_index on create_index_13(col2);
create table create_index_14 (col1 bigint primary key,col2 timestamp,col3 timestamp);
create unique index timestamp_index on create_index_14(col2);
create table create_index_15 (col1 bigint primary key,col2 blob,col3 blob);
create unique index blob_index on create_index_15(col2);
create table create_index_16 (col1 bigint primary key,col2 json,col3 json);
create unique index json_index on create_index_16(col2);
create table create_index_17 (col1 bigint primary key,col2 text,col3 text);
create unique index text_index on create_index_17(col2);
insert into create_index_17 values (235,'5689','132456789'),(236,'5689','232456789');
select * from create_index_17 ;
create table create_index_18 (col1 bigint primary key,col2 bool);
create unique index bool_index on create_index_18(col2);
...
update table create_index_19 set col2='chart' where col1=2;
